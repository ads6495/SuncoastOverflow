...
{
    public partial class AddedQuestionAndAnswerTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PraisesForQuestion = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PraisesForAnswer = table.Column<string>(nullable: true),
                    DateOfPost = table.Column<DateTime>(nullable: false),
